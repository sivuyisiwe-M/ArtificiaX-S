  ...
  jobPostForm.addEventListener('submit', async function(e) {
    ...
    try {
      ...
      const newJob = {
        title,
        companyName,
        company: companyName, // Add both for compatibility
        description,
        location,
        type,
        field,
      ...
      // Option 1: Reload the page to see the new job
      // window.location.reload();
      
      // Option 2: Redirect to opportunities page
      // window.location.href = '/opportunities.html';
      
      // Option 3: Trigger a custom event to update other pages
      window.dispatchEvent(new CustomEvent('jobPosted', { 
        detail: { job: newJob, id: docRef.id } 
      }));
